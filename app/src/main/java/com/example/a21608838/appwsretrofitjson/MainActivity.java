package com.example.a21608838.appwsretrofitjson;
...
import retrofitUtil.APIRestService;
import retrofitUtil.RetrofitClient;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void consumirWS(View v) {
        ...
        call.enqueue(new Callback<Pokemon>(){
            String res;
            TextView tvRes = (TextView)findViewById(R.id.twResultado);
